...
>
> **Status 2026-08-05 (Session 2), PR #TBD:** LocationIQ-Frage geklärt: `LOCATIONIQ_API_KEY` ist auf Prod **nicht gesetzt** (`podman exec zvg-immo env` geprüft) — der Geocoder läuft weiterhin gegen das öffentliche, IP-gebannte `nominatim.openstreetmap.org`. Ist ein manueller Folgeschritt im `ansible`-Repo, nicht Teil dieses PRs.
>
