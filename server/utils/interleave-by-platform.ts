 ...
 * Generic over anything tagged with a `platform` — enrich.ts interleaves full
 * Auction objects, reprocess.ts interleaves its lighter {platform,externalId}
 * candidates.
 */
export function interleaveByPlatform<T extends { platform: string }>(items: T[]): T[] {
